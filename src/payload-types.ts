...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "content-library-items".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "whats-happening-here".
 */
export interface WhatsHappeningHere {
  id: number;
  image: number | Media;
  title: string;
  text: string;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'content-library-items';
        value: number | ContentLibraryItem;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "content-library-items_select".
 */
export interface ContentLibraryItemsSelect<T extends boolean = true> {
  image?: T;
  title?: T;
  description?: T;
  price?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "whats-happening-here_select".
 */
export interface WhatsHappeningHereSelect<T extends boolean = true> {
  image?: T;
  title?: T;
  text?: T;
  buttonLabel?: T;
